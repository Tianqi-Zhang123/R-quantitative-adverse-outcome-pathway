...
pa <- ggpairs(response_df) +
  theme(text = element_text(size = 14))
ggsave(filename = "../data/MM/ggpairs.pdf",
       plot = pa,
       width = 8,
       height = 6,
       dpi = 300)
...
p1 <- ggplot() +
  # predicted data
  geom_point(data = response_df, aes(x = KE1, y = p_KE3, color = "Predicted from cm", shape = "Predicted from cm"), size = 2) +
  ...
  scale_color_manual(name = "Data Type", values = c("Predicted from cm" = "red", "Predicted from drm" = "red")) +
  scale_shape_manual(name = "Data Type", values = c("Predicted from cm" = 16, "Predicted from drm" = 1)) +
  theme_minimal() +
...
p2 <- ggplot(response_df, aes(x = KE2)) +
  # predicted data
   geom_point(data = response_df, aes(x = KE2, y = p_KE3, color = "Predicted from cm", shape = "Predicted from cm"), size = 2) +
...
print(p1)
print(p2)
ggsave(filename = "../data/MM/p1.pdf",
       plot = p1,
       width = 8,
       height = 5,
       dpi = 300)
ggsave(filename = "../data/MM/p2.pdf",
       plot = p2,
       width = 8,
       height = 5,
       dpi = 300)
